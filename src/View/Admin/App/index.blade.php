...
<div class="p-6 pb-0" id="counter">
    <div class="p-5 rounded border shadow-sm text-yellow-900 bg-yellow-200 border-yellow-400 mb-4" style="">
        ...
        <div class="mt-1  lg:ml-10 opacity-90">如果需自动生成对应代码则需要填写应用等信息， 仅生成 modules 目录下的应用。</div>
    </div>
    ...
    <div class="bg-white rounded shadow p-6 mb-4">
        <div class="grid grid-cols-2  gap-4 ">
            <div>
                ...
                <div>
                    <input type="text" class="form-input" v-model="info.class" placeholder="请输入控制器路径">
                </div>
            </div>
            <div>
    ...
    <div class="tabs mb-4">
        <ul class="tabs-nav">
            <li>
                <a class="tabs-item" :class="{'tabs-active': tab === 0}" href="javascript:;" @click="tab = 0">表单元素</a>
            </li>
            <li>
                <a class="tabs-item" :class="{'tabs-active': tab === 1}" href="javascript:;" @click="tab = 1">表格元素</a>
            </li>
            <li>
